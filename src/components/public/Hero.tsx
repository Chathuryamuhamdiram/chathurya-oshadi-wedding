    ...
    <section id="hero" ref={ref} className="relative min-h-screen w-full flex flex-col items-center justify-center bg-background z-10">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        <motion.div 
          ...
          style={{ backgroundImage: `url('${imageUrl}')`, y: yImage }}
        />
      </div>
      ...
      {/* Gradient fading to Charcoal to anchor the light text */}
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-black/20 to-[#1A1A18] z-0" />
      <div className="absolute inset-0 z-[1] bg-foreground/5 mix-blend-multiply" />
      ...
      >
        <motion.h1
          ...
          className="text-[13.5vw] sm:text-[4.5rem] leading-[1] md:text-8xl lg:text-[10.5rem] font-serif text-[#F5F2EA] lg:leading-[0.9] tracking-tight flex flex-col items-center drop-shadow-lg"
        >
          <span>OSHADI</span>
          <span className="italic text-[#E5D3B3] font-light text-[15vw] sm:text-6xl md:text-7xl lg:text-[8rem] -my-1 md:-my-4 lg:-my-6 drop-shadow-md">&</span>
          <span>CHATHURYA</span>
        </motion.h1>
